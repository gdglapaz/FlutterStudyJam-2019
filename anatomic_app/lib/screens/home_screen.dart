  ...
  Widget build(BuildContext context) {
    final mVerticalList = Container(
      ...
      child: ListView(
        ...
        children: <Widget>[
          CustomCard.vertical(2, "Endurance", "assets/pic_1.jpg",Icon(Icons.account_balance_wallet), mPurpleColor ),
          CustomCard.vertical(3, "Week Point", "assets/pic_2.jpg",Icon(Icons.airline_seat_recline_extra), Color(0xFF0091ea) ),
          CustomCard.vertical(4, "Perfect Score", "assets/pic_3.jpg",Icon(Icons.accessible_forward),Color(0xFF00bfa5)),
        ],
      ),
    );
